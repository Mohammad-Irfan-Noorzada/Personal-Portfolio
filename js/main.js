...
document.addEventListener("DOMContentLoaded", () => {
  // This waits until the HTML is fully loaded before starting the animation.
  typeNext();
});
...
window.addEventListener("scroll", scrollActive, scrollHeader(), scrollUp());
...
const sendEmail = (e) => {
  ...
  // Check if email field is not wrong
